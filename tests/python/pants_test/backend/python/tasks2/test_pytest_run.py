...
class PytestTest(PytestTestBase):
  ...
  def test_fail_fast_skips_second_red_test_with_single_chroot_run_per_target(self):
    ...
    self.run_failing_tests(targets=[self.red_in_class, self.red], failed_targets=[self.red_in_class],
                           fail_fast=True,
                           run_per_target=True,
                           partition_strategy=PartitionTargets.STRATEGY_GLOBAL)
  ...
  def test_fail_fast_skips_second_red_test_with_single_chroot_single_run(self):
    ...
    self.run_failing_tests(targets=[self.red_in_class, self.red], failed_targets=[self.red],
                           fail_fast=True,
